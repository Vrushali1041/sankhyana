        ...
        <div>
            ...
            <section className="course-details">
                <div className="detail">
                    ...
                    <button className="sas-btn" onClick={handleSas}>More</button>
                </div>
                <div className="img">
            ...
            <section className="course-details">
                ...
                <div className="detail data">
                    ...
                    <button className="sas-btn" onClick={handleDataScience}>More</button>
                </div>
            </section>
            ...
            <section className="course-details">
                <div className="detail">
                    ...
                    <button className="sas-btn" onClick={handleFullStacj}>More</button>
                </div>
                <div className="img">
            ...
            <section className="course-details">
                ...
                <div className="detail internship">
                    ...
                    <button className="sas-btn" onClick={handleInternship}>More</button>
                </div>
            </section>
            ...
            <section className="course-details">
                <div className="detail">
                    ...
                    <button className="sas-btn" onClick={handleScholarship}>More</button>
                </div>
                <div className="img">
                    <img src={fullStack} alt="img1" className="course-images" />
                </div>
